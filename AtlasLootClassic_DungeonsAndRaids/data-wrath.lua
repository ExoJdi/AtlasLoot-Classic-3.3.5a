...
local addonname = (AtlasLoot and AtlasLoot.NormalizeAddonName and AtlasLoot.NormalizeAddonName(folderName)) or folderName
...
local NAME_CAVERNS_OF_TIME = "%s"
local NAME_NEXUS = "%s"
local NAME_AZJOL = "%s"
local NAME_ULDUAR = "%s"
local NAME_UTGARDE = "%s"
local NAME_ICC = "%s"
local NAME_AT = "%s"
...
data["Ulduar"] = {
    ...
    items = {
        { -- UlduarLeviathan
            ...
            [RAID10_DIFF] = {
                { 1,  45282 }, -- Ironsoul
                { 2,  45283 }, -- Flamewatch Armguards
                { 3,  45284 }, -- Kinetic Ripper
                { 4,  45285 }, -- Might of the Leviathan
                { 5,  45286 }, -- Pyrite Infuser
                { 6,  45287 }, -- Firesoul
                { 7,  45288 }, -- Firestrider Chestguard
                { 8,  45289 }, -- Lifespark Visage
                { 9,  45291 }, -- Combustion Bracers
                { 10, 45292 }, -- Energy Siphon
                { 18, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil,            "AC_UlduarFlameLeviathan10" },
                { 23, "ac3056",              nil, nil,                AL["Hard Mode"] },
                { 24, 45293 }, -- Handguards of Potent Cures
                { 25, 45300 }, -- Mantle of Fiery Vengeance
                { 26, 45295 }, -- Gilded Steel Legplates
                { 27, 45297 }, -- Shimmering Seal
                { 28, 45296 } -- Twirling Blades
            },
            [RAID25_DIFF] = {
                ...
                { 23, "ac3057",              nil, nil,                AL["Hard Mode"] },
                { 24, 45135 }, -- Boots of Fiery Resolution
                { 25, 45136 }, -- Shoulderpads of Dormant Energies
                { 26, 45134 }, -- Plated Leggings of Ruination
                { 27, 45133 }, -- Pendant of Fiery Havoc
                { 28, 45132 } -- Golden Saronite Dragon
            }
        }, {         -- UlduarIgnis
        ...
        DisplayIDs = { { 33118 } },
        [RAID10_DIFF] = {
            { 1,  45309 }, -- Rifle of the Platinum Guard
            { 2,  45310 }, -- Gauntlets of the Iron Furnace
            { 3,  45311 }, -- Relentless Edge
            { 4,  45312 }, -- Gloves of Smoldering Touch
            { 5,  45313 }, -- Furnace Stone
            { 6,  45314 }, -- Igniter Rod
            { 7,  45316 }, -- Armbraces of the Vibrant Flame
            { 8,  45317 }, -- Shawl of the Caretaker
            { 9,  45318 }, -- Drape of Fuming Anger
            { 10, 45321 }, -- Pauldrons of Tempered Will
            { 18, "ac2927" }, { 19, "ac2925" }, { 20, "ac2930" } },
        [RAID25_DIFF] = {
        ...
        [RAID10_DIFF] = {
            ...
            { 2,  45299 }, -- Dragonsteel Faceplate
            { 3,  45301 }, -- Bracers of the Smothering Inferno
            { 4,  45302 }, -- Treads of the Invader
            { 5,  45303 }, -- Band of Draconic Guile
            { 6,  45304 }, -- Stormtempered Girdle
            { 7,  45305 }, -- Breastplate of the Afterlife
            { 8,  45306 }, -- Binding of the Dragon Matriarch
        ...
        DisplayIDs = { { 33293 } },
        [RAID10_DIFF] = {
            { 1,  45675 }, -- Power Enhancing Loop
            { 2,  45676 }, -- Chestplate of Vicious Potency
            { 3,  45677 }, -- Treacherous Shoulderpads
            { 4,  45679 }, -- Gloves of Taut Grip
            { 5,  45680 }, -- Armbands of the Construct
            { 6,  45682 }, -- Pulsing Spellshield
            { 7,  45685 }, -- Plasma Foil
            { 8,  45686 }, -- Vest of the Glowing Crescent
            { 9,  45687 }, -- Helm of Veiled Energies
            { 10, 45694 }, -- Conductive Cord
            { 18, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil,            "AC_UlduarXTDeconstructor10" },
            { 23, "ac3058",              nil, nil,                AL["Hard Mode"] },
            { 24, 45869 }, -- Fluxing Energy Coils
            { 25, 45867 }, -- Breastplate of the Stoneshaper
            { 26, 45871 }, -- Seal of Ulduar
            { 27, 45868 }, -- Aesir's Edge
            { 28, 45870 } -- Magnetized Projectile Emitter
        },
        [RAID25_DIFF] = {
            ...
            { 23, "ac3059",              nil, nil,                AL["Hard Mode"] },
        ...
        [RAID10_DIFF] = {
            ...
            { 2,  45324 }, -- Leggings of Swift Reflexes
            { 3,  45329 }, -- Circlet of True Sight
            { 4,  45330 }, -- Greaves of Iron Intensity
            { 5,  45331 }, -- Rune-Etched Nightblade
            { 6,  45332 }, -- Stormtip
            { 7,  45333 }, -- Belt of the Iron Servant
            { 8,  45378 }, -- Boots of the Petrified Forest
            { 9,  45418 }, -- Lady Maye's Sapphire Ring
            { 10, 45423 }, -- Runetouch Handwraps
            { 18, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil,            "AC_UlduarCouncil10" },
            { 23, "ac2941",              nil, nil,                AL["Hard Mode"] },
            { 24, 45455 }, -- Belt of the Crystal Tree
            { 25, 45447 }, -- Watchful Eye
            { 26, 45456 }, -- Loop of the Agile
            { 27, 45449 }, -- The Masticator
            { 28, 45448 }, -- Perilous Bite
            { 29, 45506 } -- Archivum Data Disc
        },
        [RAID25_DIFF] = {
        ...
        DisplayIDs = { { 32871 } },
        [RAID10_DIFF] = {
            { 1,  46042 }, -- Drape of the Messenger (ilvl 226)
            { 2,  46045 }, -- Pulsar Gloves (ilvl 226)
            { 3,  46050 }, -- Starlight Treads (ilvl 226)
            { 4,  46043 }, -- Gloves of the Endless Dark (ilvl 226)
            { 5,  46049 }, -- Zodiac Leggings (ilvl 226)
            { 6,  46044 }, -- Observer's Mantle (ilvl 226)
            { 7,  46037 }, -- Shoulderplates of the Celestial Watch (ilvl 226)
            { 8,  46039 }, -- Breastplate of the Timeless (ilvl 226)
            { 9,  46041 }, -- Starfall Girdle (ilvl 226)
            { 10, 46047 }, -- Pendant of the Somber Witness (ilvl 226)
            { 11, 46040 }, -- Strength of the Heavens (ilvl 226)
            { 12, 46048 }, -- Band of Lights (ilvl 226)
            { 13, 46046 }, -- Nebula Band (ilvl 226)
            { 14, 46038 }, -- Dark Matter (ilvl 226)
            { 15, 46051 }, -- Meteorite Crystal (ilvl 226)
            { 18, 46052 }, -- Reply-Code Alpha (ilvl 226)
            { 23, "ac3036" }
        },
        [RAID25_DIFF] = {
            { 1,  45665 }, -- Pharos Gloves (ilvl 239)
            { 2,  45619 }, -- Starwatcher's Binding (ilvl 239)
            { 3,  45611 }, -- Solar Bindings (ilvl 239)
            { 4,  45616 }, -- Star-beaded Clutch (ilvl 239)
            { 5,  45610 }, -- Boundless Gaze (ilvl 239)
            { 6,  45615 }, -- Planewalker Treads (ilvl 239)
            { 7,  45594 }, -- Legplates of the Endless Void (ilvl 239)
            { 8,  45599 }, -- Sabatons of Lifeless Night (ilvl 239)
            { 9,  45617 }, -- Cosmos (ilvl 239)
            { 10, 45620 }, -- Starshard Edge (ilvl 239)
            { 11, 45607 }, -- Fang of Oblivion (ilvl 239)
            { 12, 45612 }, -- Constellus (ilvl 239)
            { 13, 45613 }, -- Dreambinder (ilvl 239)
            { 14, 45587 }, -- Bulwark of Algalon (ilvl 239)
            { 15, 45570 }, -- Skyforge Crossbow (ilvl 239)
            { 16, 45609 }, -- Comet's Trail (ilvl 239)
            { 18, 46053 }, -- Reply-Code Alpha (ilvl 239)
            { 23, "ac3037" } }
    }, {             -- UlduarAuriaya
        name = AL["Auriaya"],
        npcID = 33515,
        ...
        DisplayIDs = { { 32845 } },
        [RAID10_DIFF] = {
            { 1,  45873 }, -- Winter's Frigid Embrace (ilvl 219)
            { 2,  45464 }, -- Cowl of Icy Breaths (ilvl 219)
            { 3,  45874 }, -- Signet of Winter (ilvl 219)
            { 4,  45458 }, -- Stormedge (ilvl 219)
            { 5,  45872 }, -- Avalanche (ilvl 219)
            { 7,  45650 }, -- Leggings of the Wayward Conqueror (ilvl 219)
            { 8,  45651 }, -- Leggings of the Wayward Protector (ilvl 219)
            { 9,  45652 }, -- Leggings of the Wayward Vanquisher (ilvl 219)
            { 18, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil,            "AC_UlduarHodir10" },
            { 23, "ac3182",              nil, nil,                AL["Hard Mode"] },
            { 24, 45888 }, -- Bitter Cold Armguards
            { 25, 45876 }, -- Shiver
            { 26, 45886 }, -- Icecore Staff
            { 27, 45887 }, -- Ice Layered Barrier
            { 28, 45877 }, -- The Boreal Guard
            { 29, 45786 } -- Hodir's Sigil
        },
        [RAID25_DIFF] = {
            ...
            { 7,  45632 }, -- Breastplate of the Wayward Conqueror
            { 8,  45633 }, -- Breastplate of the Wayward Protector
            { 9,  45634 }, -- Breastplate of the Wayward Vanquisher
            { 16, 45038 }, -- Fragment of Val'anyr
            { 18, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil,            "AC_UlduarHodir25" },
            { 23, "ac3184",              nil, nil,                AL["Hard Mode"] },
            { 24, 45461 }, -- Drape of Icy Intent
            { 25, 45462 }, -- Gloves of the Frozen Glade
            { 26, 45460 }, -- Bindings of Winter Gale
            { 27, 45459 }, -- Frigid Strength of Hodir
            { 28, 45612 }, -- Constellus
            { 29, 45457 }, -- Staff of Endless Winter
            { 30, 45815 } -- Hodir's Sigil
        }
    }, {             -- UlduarThorim
        name = AL["Thorim"],
        npcID = 32865,
        ...
        [RAID10_DIFF] = {
            { 1,  45893 }, -- Guise of the Midgard Serpent (ilvl 219)
            { 2,  45927 }, -- Handwraps of Resonance (ilvl 219)
            { 3,  45894 }, -- Leggings of Unstable Discharge (ilvl 219)
            { 4,  45895 }, -- Belt of the Blood Pit (ilvl 219)
            { 5,  45892 }, -- Legacy of Thunder (ilvl 219)
            { 7,  45659 }, -- Spaulders of the Wayward Conqueror (ilvl 219)
            { 8,  45660 }, -- Spaulders of the Wayward Protector (ilvl 219)
            { 9,  45661 }, -- Spaulders of the Wayward Vanquisher (ilvl 219)
            { 16, "ac2971" }, { 17, "ac2973" }, { 18, "ac3176" }, { 19, "ac2977" }, { 20, "ac2975" },
            { 23, "ac3176", nil, nil, AL["Hard Mode"] },
            { 24, 45928 }, -- Gauntlets of the Thunder God (ilvl 219)
            { 25, 45933 }, -- Pendant of the Shallow Grave (ilvl 219)
            { 26, 45931 }, -- Mjolnir Runestone (ilvl 219)
            { 27, 45929 }, -- Sif's Remembrance (ilvl 219)
            { 28, 45930 }, -- Combatant's Bootblade (ilvl 219)
            { 29, 45784 } -- Thorim's Sigil (ilvl 219)
        },
        [RAID25_DIFF] = {
            { 1,  45468 }, -- Leggings of Lost Love (ilvl 226)
            { 2,  45467 }, -- Belt of the Betrayed (ilvl 226)
            { 3,  45469 }, -- Sif's Promise (ilvl 226)
            { 4,  45466 }, -- Scale of Fates (ilvl 226)
            { 5,  45463 }, -- Vulmir, the Northern Tempest (ilvl 226)
            { 7,  45638 }, -- Crown of the Wayward Conqueror (ilvl 226)
            { 8,  45639 }, -- Crown of the Wayward Protector (ilvl 226)
            { 9,  45640 }, -- Crown of the Wayward Vanquisher (ilvl 226)
            { 16, 45038 }, -- Fragment of Val'anyr (ilvl 226)
            { 18, "ac2972" }, { 19, "ac2974" }, { 20, "ac3183" }, { 21, "ac2978" }, { 22, "ac2976" },
            { 23, "ac3183", nil, nil, AL["Hard Mode"] },
            { 24, 45473 }, -- Embrace of the Gladiator (ilvl 226)
            { 25, 45474 }, -- Pauldrons of the Combatant (ilvl 226)
            { 26, 45472 }, -- Warhelm of the Champion (ilvl 226)
            { 27, 45471 }, -- Fate's Clutch (ilvl 226)
            { 28, 45570 }, -- Skyforge Crossbow (ilvl 226)
            { 29, 45470 }, -- Wisdom's Hold (ilvl 226)
            { 30, 45817 } -- Thorim's Sigil (ilvl 226)
        }
    }, {             -- UlduarFreya
        name = AL["Freya"],
        npcID = 32906,
        ...
        [RAID10_DIFF] = {
            { 1,  45940 }, -- Tunic of the Limber Stalker (ilvl 219)
            { 2,  45941 }, -- Chestguard of the Lasher (ilvl 219)
            { 3,  45935 }, -- Ironbark Faceguard (ilvl 219)
            { 4,  45936 }, -- Legplates of Flourishing Resolve (ilvl 219)
            { 5,  45934 }, -- Unraveling Reach (ilvl 219)
            { 7,  45644 }, -- Gloves of the Wayward Conqueror (ilvl 219)
            { 8,  45645 }, -- Gloves of the Wayward Protector (ilvl 219)
            { 9,  45646 }, -- Gloves of the Wayward Vanquisher (ilvl 219)
            { 11, 46110 }, -- Alchemist's Cache (ilvl 219)
            { 18, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil,            "AC_UlduarFreya10" },
            { 23, "ac3179",              nil, nil,                AL["Hard Mode"] },
            { 24, 45943 }, -- Gloves of Whispering Winds (ilvl 219)
            { 25, 45945 }, -- Seed of Budding Carnage (ilvl 219)
            { 26, 45946 }, -- Fire Orchid Signet (ilvl 219)
            { 27, 45947 }, -- Serilas, Blood Blade of Invar One-Arm (ilvl 219)
            { 28, 45294 }, -- Petrified Ivy Sprig (ilvl 219)
            { 29, 45788 } -- Freya's Sigil (ilvl 219)
        },
        [RAID25_DIFF] = {
            { 1,  45483 }, -- Boots of the Servant (ilvl 226)
            { 2,  45482 }, -- Leggings of the Lifetender (ilvl 226)
            { 3,  45481 }, -- Gauntlets of Ruthless Reprisal (ilvl 226)
            { 4,  45480 }, -- Nymph Heart Charm (ilvl 226)
            { 5,  45479 }, -- The Lifebinder (ilvl 226)
            { 7,  45653 }, -- Legplates of the Wayward Conqueror (ilvl 226)
            { 8,  45654 }, -- Legplates of the Wayward Protector (ilvl 226)
            { 9,  45655 }, -- Legplates of the Wayward Vanquisher (ilvl 226)
            { 11, 46110 }, -- Alchemist's Cache (ilvl 226)
            { 16, 45038 }, -- Fragment of Val'anyr (ilvl 226)
            { 18, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil,            "AC_UlduarFreya25" },
            { 23, "ac3187",              nil, nil,                AL["Hard Mode"] },
            { 24, 45486 }, -- Drape of the Sullen Goddess (ilvl 226)
            { 25, 45488 }, -- Leggings of the Enslaved Idol (ilvl 226)
            { 26, 45487 }, -- Handguards of Revitalization (ilvl 226)
            { 27, 45485 }, -- Bronze Pendant of the Vanir (ilvl 226)
            { 28, 45484 }, -- Bladetwister (ilvl 226)
            { 29, 45613 }, -- Dreambinder (ilvl 226)
            { 30, 45814 } -- Freya's Sigil (ilvl 226)
        }
    }, {             -- UlduarMimiron
        name = AL["Mimiron"],
        npcID = 33350,
        DisplayIDs = { { 33350 } },
        [RAID10_DIFF] = {
            { 1,  45973 }, -- Stylish Power Cape (ilvl 219)
            { 2,  45976 }, -- Static Charge Handwraps (ilvl 219)
            { 3,  45974 }, -- Shoulderguards of Assimilation (ilvl 219)
            { 4,  45975 }, -- Cable of the Metrognome (ilvl 219)
            { 5,  45972 }, -- Pulse Baton (ilvl 219)
            { 7,  45647 }, -- Helm of the Wayward Conqueror (ilvl 219)
            { 8,  45648 }, -- Helm of the Wayward Protector (ilvl 219)
            { 9,  45649 }, -- Helm of the Wayward Vanquisher (ilvl 219)
            { 18, "ac3180" }, { 21, "ac3138" }, { 22, "ac2989" },
            { 23, "ac3180", nil, nil, AL["Hard Mode"] },
            { 24, 45993 }, -- Mimiron's Flight Goggles (ilvl 219)
            { 25, 45989 }, -- Tempered Mercury Greaves (ilvl 219)
            { 26, 45982 }, -- Fused Alloy Legplates (ilvl 219)
            { 27, 45988 }, -- Greaves of the Iron Army (ilvl 219)
            { 28, 45990 }, -- Fusion Blade (ilvl 219)
            { 29, 45787 } -- Mimiron's Sigil (ilvl 219)
        },
        [RAID25_DIFF] = {
            { 1,  45493 }, -- Asimov's Drape (ilvl 226)
            { 2,  45492 }, -- Malleable Steelweave Mantle (ilvl 226)
            { 3,  45491 }, -- Waistguard of the Creator (ilvl 226)
            { 4,  45490 }, -- Pandora's Plea (ilvl 226)
            { 5,  45489 }, -- Insanity's Grip (ilvl 226)
            { 7,  45641 }, -- Gauntlets of the Wayward Conqueror (ilvl 226)
            { 8,  45642 }, -- Gauntlets of the Wayward Protector (ilvl 226)
            { 9,  45643 }, -- Gauntlets of the Wayward Vanquisher (ilvl 226)
            { 16, 45038 }, -- Fragment of Val'anyr (ilvl 226)
            { 18, "ac3189" }, { 19, "ac2995" }, { 20, "ac3237" },
            { 23, "ac3189", nil, nil, AL["Hard Mode"] },
            { 24, 45496 }, -- Titanskin Cloak (ilvl 226)
            { 25, 45497 }, -- Crown of Luminescence (ilvl 226)
            { 26, 45663 }, -- Armbands of Bedlam (ilvl 226)
            { 27, 45495 }, -- Conductive Seal (ilvl 226)
            { 28, 45494 }, -- Delirium's Touch (ilvl 226)
            { 29, 45620 }, -- Starshard Edge (ilvl 226)
            { 30, 45816 } -- Mimiron's Sigil (ilvl 226)
        }
    }, {             -- UlduarGeneralVezax
        ...
        DisplayIDs = { { 33271 } },
        [RAID10_DIFF] = {
            { 1,  46014 }, -- Saronite Animus Cloak (ilvl 219)
            { 2,  46013 }, -- Underworld Mantle (ilvl 219)
            { 3,  46012 }, -- Vestments of the Piercing Light (ilvl 219)
            { 4,  46009 }, -- Bindings of the Depths (ilvl 219)
            { 5,  46346 }, -- Boots of Unsettled Prey (ilvl 219)
            { 6,  45997 }, -- Gauntlets of the Wretched (ilvl 219)
            { 7,  46008 }, -- Choker of the Abyss (ilvl 219)
            { 8,  46015 }, -- Pendant of Endless Despair (ilvl 219)
            { 9,  46010 }, -- Darkstone Ring (ilvl 219)
            { 10, 46011 }, -- Shadowbite (ilvl 219)
            { 11, 45996 }, -- Hoperender (ilvl 219)
            { 18, "ac3181" }, { 19, "ac2996" },
            { 23, "ac3181", nil, nil, AL["Hard Mode"] },
            { 24, 46032 }, -- Drape of the Faceless General (ilvl 219)
            { 25, 46034 }, -- Leggings of Profound Darkness (ilvl 219)
            { 26, 46036 }, -- Void Sabre (ilvl 219)
            { 27, 46035 }, -- Aesuga, Hand of the Ardent Champion (ilvl 219)
            { 28, 46033 } -- Tortured Earth (ilvl 219)
        },
        [RAID25_DIFF] = {
            { 1,  45514 }, -- Mantle of the Unknowing (ilvl 226)
            { 2,  45508 }, -- Belt of the Darkspeaker (ilvl 226)
            { 3,  45512 }, -- Grips of the Unbroken (ilvl 226)
            { 4,  45504 }, -- Darkcore Leggings (ilvl 226)
            { 5,  45513 }, -- Boots of the Forgotten Depths (ilvl 226)
            { 6,  45502 }, -- Helm of the Faceless (ilvl 226)
            { 7,  45505 }, -- Belt of Clinging Hope (ilvl 226)
            { 8,  45501 }, -- Boots of the Underdweller (ilvl 226)
            { 9,  45503 }, -- Metallic Loop of the Sufferer (ilvl 226)
            { 10, 45515 }, -- Ring of the Vacant Eye (ilvl 226)
            { 11, 45507 }, -- The General's Heart (ilvl 226)
            { 12, 45509 }, -- Idol of the Corruptor (ilvl 226)
            { 13, 45145 }, -- Libram of the Sacred Shield (ilvl 226)
            { 14, 45498 }, -- Lotrafen, Spear of the Damned (ilvl 226)
            { 15, 45511 }, -- Scepter of Lost Souls (ilvl 226)
            { 16, 45038 }, -- Fragment of Val'anyr (ilvl 226)
            { 18, "ac3188" }, { 19, "ac2997" },
            { 23, "ac3188", nil, nil, AL["Hard Mode"] },
            { 24, 45520 }, -- Handwraps of the Vigilant (ilvl 226)
            { 25, 45519 }, -- Vestments of the Blind Denizen (ilvl 226)
            { 26, 45517 }, -- Pendulum of Infinity (ilvl 226)
            { 27, 45518 }, -- Flare of the Heavens (ilvl 226)
            { 28, 45516 } -- Voldrethar, Dark Blade of Oblivion (ilvl 226)
        }
    }, {             -- UlduarGeneralVezax
        name = AL["Yogg-Saron"],
        NameColor = PURPLE,
        ...
        DisplayIDs = { { 33271 } },
        [RAID10_DIFF] = {
            { 1,  46030 }, -- Treads of the Dragon Council (ilvl 219)
            { 2,  46019 }, -- Leggings of the Insatiable (ilvl 219)
            { 3,  46028 }, -- Faceguard of the Eyeless Horror (ilvl 219)
            { 4,  46022 }, -- Pendant of a Thousand Maws (ilvl 219)
            { 5,  46021 }, -- Royal Seal of King Llane (ilvl 219)
            { 6,  46024 }, -- Kingsbane (ilvl 219)
            { 7,  46016 }, -- Abaddon (ilvl 219)
            { 8,  46031 }, -- Touch of Madness (ilvl 219)
            { 9,  46025 }, -- Devotion (ilvl 219)
            { 10, 46018 }, -- Deliverance (ilvl 219)
            { 12, 45635 }, -- Chestguard of the Wayward Conqueror (ilvl 219)
            { 13, 45636 }, -- Chestguard of the Wayward Protector (ilvl 219)
            { 14, 45637 }, -- Chestguard of the Wayward Vanquisher (ilvl 219)
            { 18, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil,            "AC_UlduarYoggSaron10" },
            { 23, "ac3158",              nil, nil,                AL["Hard Mode"] },
            { 24, 46068 }, -- Amice of Inconceivable Horror (ilvl 219)
            { 25, 46095 }, -- Soul-Devouring Cinch (ilvl 219)
            { 26, 46096 }, -- Signet of Soft Lament (ilvl 219)
            { 27, 46097 }, -- Caress of Insanity (ilvl 219)
            { 28, 46067 }, -- Hammer of Crushing Whispers (ilvl 219)
            { 29, "ac3159",              nil, nil,                AL["Hard Mode"] },
            { 30, 46312 } -- Vanquished Clutches of Yogg-Saron (ilvl 219)
        },
        [RAID25_DIFF] = {
            { 1,  45529 }, -- Shawl of Haunted Memories (ilvl 226)
            { 2,  45532 }, -- Cowl of Dark Whispers (ilvl 226)
            { 3,  45523 }, -- Garona's Guise (ilvl 226)
            { 4,  45524 }, -- Chestguard of Insidious Intent (ilvl 226)
            { 5,  45531 }, -- Chestguard of the Fallen God (ilvl 226)
            { 6,  45525 }, -- Godbane Signet (ilvl 226)
            { 7,  45530 }, -- Sanity's Bond (ilvl 226)
            { 8,  45522 }, -- Blood of the Old God (ilvl 226)
            { 9,  45527 }, -- Soulscribe (ilvl 226)
            { 10, 45521 }, -- Earthshaper (ilvl 226)
            { 12, 45656 }, -- Mantle of the Wayward Conqueror (ilvl 226)
            { 13, 45657 }, -- Mantle of the Wayward Protector (ilvl 226)
            { 14, 45658 }, -- Mantle of the Wayward Vanquisher (ilvl 226)
            { 16, 45038 }, -- Fragment of Val'anyr (ilvl 226)
            { 18, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil,            "AC_UlduarYoggSaron25" },
            { 23, "ac3163",              nil, nil,                AL["Hard Mode"] },
            { 24, 45537 }, -- Treads of the False Oracle (ilvl 226)
            { 25, 45536 }, -- Legguards of Cunning Deception (ilvl 226)
            { 26, 45534 }, -- Seal of the Betrayed King (ilvl 226)
            { 27, 45535 }, -- Show of Faith (ilvl 226)
            { 28, 45533 }, -- Dark Edge of Depravity (ilvl 226)
            { 29, "ac3164",              nil, nil,                AL["Hard Mode"] },
            { 30, 45693 } -- Mimiron's Head (ilvl 226)
        }
    }, {             -- Trash
        name = AL["Trash"],
        ExtraList = true,
        [RAID10_DIFF] = {
            { 1,  46341 }, -- Drape of the Spellweaver (ilvl 219)
            { 2,  46347 }, -- Cloak of the Dormant Blaze (ilvl 219)
            { 3,  46344 }, -- Iceshear Mantle (ilvl 219)
            { 4,  46346 }, -- Boots of Unsettled Prey (ilvl 219)
            { 5,  46345 }, -- Bracers of Righteous Reformation (ilvl 219)
            { 6,  46340 }, -- Adamant Handguards (ilvl 219)
            { 7,  46343 }, -- Fervor of the Protectorate (ilvl 219)
            { 8,  46339 }, -- Mimiron's Repeater (ilvl 219)
            { 9,  46351 }, -- Bloodcrush Cudgel (ilvl 219)
            { 10, 46350 }, -- Pillar of Fortitude (ilvl 219)
            { 11, 46342 } -- Golemheart Longbow (ilvl 219)
        },
        [RAID25_DIFF] = {
            { 1,  45541 }, -- Shroud of Alteration (ilvl 226)
            { 2,  45549 }, -- Grips of Chaos (ilvl 226)
            { 3,  45547 }, -- Relic Hunter's Cord (ilvl 226)
            { 4,  45548 }, -- Belt of the Sleeper (ilvl 226)
            { 5,  45543 }, -- Shoulders of Misfortune (ilvl 226)
            { 6,  45544 }, -- Leggings of the Tortured Earth (ilvl 226)
            { 7,  45542 }, -- Greaves of the Stonewarder (ilvl 226)
            { 8,  45540 }, -- Bladebearer's Signet (ilvl 226)
            { 9,  45539 }, -- Pendant of Focused Energies (ilvl 226)
            { 10, 45538 }, -- Titanstone Pendant (ilvl 226)
            { 11, 46138 }, -- Idol of the Flourishing Life (ilvl 226)
            { 12, 45605 } -- Daschal's Bite (ilvl 226)
        }
    }, {             -- Patterns
        name = AL["Patterns"],
        ExtraList = true,
        [RAID10_DIFF] = {
            { 1,  45089 }, -- Plans: Battlelord's Plate Boots (ilvl 219)
            { 2,  45088 }, -- Plans: Belt of the Titans (ilvl 219)
            { 3,  45092 }, -- Plans: Indestructible Plate Girdle (ilvl 219)
            { 4,  45090 }, -- Plans: Plate Girdle of Righteousness (ilvl 219)
            { 5,  45093 }, -- Plans: Spiked Deathdealers (ilvl 219)
            { 6,  46027 }, -- Formula: Enchant Weapon - Blade Ward (ilvl 219)
            { 7,  46348 }, -- Formula: Enchant Weapon - Blood Draining (ilvl 219)
            { 8,  45100 }, -- Pattern: Belt of Arctic Life (ilvl 219)
            { 9,  45094 }, -- Pattern: Belt of Dragons (ilvl 219)
            { 10, 45096 }, -- Pattern: Blue Belt of Chaos (ilvl 219)
            { 11, 45095 }, -- Pattern: Boots of Living Scale (ilvl 219)
            { 12, 45101 }, -- Pattern: Boots of Wintry Endurance (ilvl 219)
            { 13, 45098 }, -- Pattern: Death-warmed Belt (ilvl 219)
            { 14, 45099 }, -- Pattern: Footpads of Silence (ilvl 219)
            { 15, 45097 }, -- Pattern: Lightning Grounded Boots (ilvl 219)
            { 16, 45104 }, -- Pattern: Cord of the White Dawn (ilvl 219)
            { 17, 45102 }, -- Pattern: Sash of Ancient Power (ilvl 219)
            { 19, 45105 }, -- Pattern: Savior's Slippers (ilvl 219)
            { 20, 45103 }, -- Pattern: Spellslinger's Slippers (ilvl 219)
            { 22, 45087 }, -- Runed Orb (ilvl 219)
        },
        [RAID25_DIFF] = {
            { 1,  45089 }, -- Plans: Battlelord's Plate Boots (ilvl 219)
            { 2,  45088 }, -- Plans: Belt of the Titans (ilvl 219)
            ...
            { 16, 45104 }, -- Pattern: Cord of the White Dawn (ilvl 219)
            { 17, 45102 }, -- Pattern: Sash of Ancient Power (ilvl 219)
            { 18, 45105 }, -- Pattern: Savior's Slippers (ilvl 219)
            { 19, 45103 }, -- Pattern: Spellslinger's Slippers (ilvl 219)
            { 21, 45087 }, -- Runed Orb (ilvl 219)
        }
...
local __AL_NAXX_AC_FIX_DONE = true
if data and data["NaxxramasWrath"] and WOTLK_NAXXRAMAS_AC_TABLE then
    local keep10, keep25 = {}, {}
    if WOTLK_NAXXRAMAS_AC_TABLE[RAID10_DIFF] then
        for i = 1, #WOTLK_NAXXRAMAS_AC_TABLE[RAID10_DIFF] do
            local row = WOTLK_NAXXRAMAS_AC_TABLE[RAID10_DIFF][i]
            if row and type(row[2]) == "number" then keep10[row[2]] = true end
        end
    end
    if WOTLK_NAXXRAMAS_AC_TABLE[RAID25_DIFF] then
        for i = 1, #WOTLK_NAXXRAMAS_AC_TABLE[RAID25_DIFF] do
            local row = WOTLK_NAXXRAMAS_AC_TABLE[RAID25_DIFF][i]
            if row and type(row[2]) == "number" then keep25[row[2]] = true end
        end
    end
    local inst = data["NaxxramasWrath"]
    if inst.items then
        for b = 1, #inst.items do
            local boss = inst.items[b]
            local list10 = boss[RAID10_DIFF]
            if type(list10) == "table" then
                for i = #list10, 1, -1 do
                    local row = list10[i]
                    local ac = row and row[2]
                    if type(ac) == "string" then
                        local id = tonumber(ac:match("^ac(%d+)$"))
                        if id and keep25[id] and not keep10[id] then
                            table.remove(list10, i)
                        end
                    end
                end
            end
            local list25 = boss[RAID25_DIFF]
            if type(list25) == "table" then
                for i = #list25, 1, -1 do
                    local row = list25[i]
                    local ac = row and row[2]
                    if type(ac) == "string" then
                        local id = tonumber(ac:match("^ac(%d+)$"))
                        if id and keep10[id] and not keep25[id] then
                            table.remove(list25, i)
                        end
                    end
                end
            end
