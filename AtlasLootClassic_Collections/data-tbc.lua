...
local function C_Map_GetAreaInfo(id)
    ...
    local d = fallback[id] or (C_Map and C_Map.GetAreaInfo and C_Map.GetAreaInfo(id)) or (GetMapNameByID and GetMapNameByID(id))
...
data["BadgeofJustice4"] = {
    name = format(AL["%s Vendor"], AL["Badge of Justice"].." P4"),
    ContentType = VENDOR_CONTENT,
    TableType = NORMAL_ITTYPE,
    gameVersion = AtlasLoot.BC_VERSION_NUM,
    items = {{
...
data["BadgeofJusticeP5"] = {
    name = format(AL["%s Vendor"], AL["Badge of Justice"].." P5"),
    ContentType = VENDOR_CONTENT,
    TableType = NORMAL_ITTYPE,
    gameVersion = AtlasLoot.BC_VERSION_NUM,
    items = {{
...
data["BCCSunmote"] = {
    ...
    items = {{
        ...
        {22, 34351},
        {24, 34169},
        {31, 34404}, -- Mask of the Fury Hunter
        {33, 34397}, -- Bladed Chaos Tunic
        {35, 34392}, -- Demontooth Shoulderpads
        {37, 34408}, -- Gloves of the Forest Drifter
        {39, 34385}, -- Leggings of the Immortal Beast
        {46, 34244},
        {48, 34195},
        {50, 34211},
        {52, 34234},
        ...
        {20, 34216},
        {22, 34167},
        {31, 34400}, -- Crown of Dath'Remar
        {33, 34388}, -- Pauldrons of Berserking
        {35, 34394}, -- Breastplate of Agony's Aversion
        {37, 34381}, -- Felstrength Legplates
        {46, 34345},
        {48, 34192},
        {50, 34215},
        {52, 34180}
...
data["MountsBC"] = {
    ...
    items = {{
        ...
        {29, 32862} -- Reins of the Violet Netherwing Drake
	        ...
	        name = AL["Crafting"],
	        [NORMAL_DIFF] = {{1, "prof44157"}, -- Turbo-Charged Flying Machine
	        {2, "prof44155"} -- Flying Machine
	        }
	    }, {
