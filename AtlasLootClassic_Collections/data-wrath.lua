...
data["DalaranVendor"] = {
    name = format(AL["%s Vendor"], C_Map_GetAreaInfo(4395)),
...
data["MountsWrath"] = {
    ...
    items = {{
        ...
        name = AL["Crafting"],
        [NORMAL_DIFF] = {{1, "prof75597"}, -- Frosty Flying Carpet
		{2, "prof60971"}, -- Magnificent Flying Carpet
		{3, "prof60969"}, -- Flying Carpet
...
data["ValentinesDayWrath"] = {
    ...
    items = {{ -- Valentineday
        ...
        name = "Shadowfang Keep - " .. AL["Apothecary Hummel"],
...
data["ScourgeInvasionWrath"] = {
    ...
    items = {{ -- ScourgeInvasionEvent1
        ...
        name = "Karazhan - " .. AL["Prince Tenris Mirkblood"],
