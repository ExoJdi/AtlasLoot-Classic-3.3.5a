...
local function C_Map_GetAreaInfo(id)
    if not id then return "" end
	    ...
	    local d = mapFix[id] or (C_Map and C_Map.GetAreaInfo and C_Map.GetAreaInfo(id)) or (GetMapNameByID and GetMapNameByID(id))
...
data["Darkmoon"] = {
    ...
    items = {
        ...
        },
        {
            name = AL["Misc"],
            [NORMAL_DIFF] = {
                { 1,  19291 }, -- Darkmoon Storage Box
                { 2,  19295 }, -- Darkmoon Flower
                { 3,  19450 }, -- Jubling
            },
        },
    },
