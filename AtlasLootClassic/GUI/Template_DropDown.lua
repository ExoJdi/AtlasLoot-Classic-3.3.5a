...
local function Toggle(self)
	-- never allow multiple dropdown lists open at once
	if LIST_IS_OPEN and LIST_IS_OPEN ~= self then
		GenerateButtonFrame(LIST_IS_OPEN, true)
	end
...
function GUI.CreateDropDown()
	...
	frame.title:SetPoint("TOPLEFT", frame, "TOPLEFT", 3, 14)
