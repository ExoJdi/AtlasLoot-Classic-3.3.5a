...
local hasTransmog = _G.C_TransmogCollection and _G.C_TransmogCollection.GetItemInfo and _G.C_TransmogCollection.GetSourceInfo and _G.C_TransmogCollection.PlayerHasTransmogItemModifiedAppearance
if not hasTransmog then
	function Transmog:New()
		local tab = {}
		function tab:IsItemUnlocked() return nil end
